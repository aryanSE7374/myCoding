...
// Given a LinkedList of integers. Modify the LinkedList in such a way that in
//  Modified LinkedList all the even numbers appear before all the odd numbers in LinkedList.
